  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        row: 'flex w-full',
        cell: 'lg:p-[1rem] sm:p-[.2rem] text-center [&:has([aria-selected])]:text-white text-sm p-0 relative focus-within:relative focus-within:z-20',
        day: cn(
          buttonVariants({ variant: 'link' }),
          'sm:h-16 lg:h-20 w-full p-0 flex items-center font-normal aria-selected:opacity-100'
        ),
        day_selected: '',
