...
const formEventoGratuito = ({ idEvento }: IEventoGratuitoProps) => {
  ...
  return (
    <div className='flex w-full flex-col gap-6'>
      <span className='text-4xl font-thin text-zinc-700'>
      ...
      <Form {...form}>
        ...
        >
          ...
          >
            ...
            <span className='pt-[.2rem]'>INSCREVER-SE</span>
          </Button>
        </form>
      </Form>
    </div>
...
export default formEventoGratuito;
